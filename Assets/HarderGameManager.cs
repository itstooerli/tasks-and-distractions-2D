...
public class HarderGameManager : MonoBehaviour
{
    /// <summary>
    ...
    /// <summary>
    /// Time at which to turn the boxes to gray
    /// </summary>
    public float TimeToTurnGray = 5;

    /// <summary>
    /// Flag for if boxes are already gray
    /// </summary>
    private bool GrayAlready = false;
    ...
    void Update()
    {
        ...
        if (!GrayAlready && Time.time > TimeToTurnGray)
        {
